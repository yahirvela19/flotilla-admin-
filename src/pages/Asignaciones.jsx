...
export default function Asignaciones() {
  ...
  const fetchData = async () => {
    ...
    const { data: chofData } = await supabase.from('choferes').select('*').eq('estatus', 'activo');
    const { data: vehData } = await supabase.from('vehiculos').select('*').eq('estatus', 'disponible');
